systemDictionary = {
    ...
    "Don't delete devices":     {"en": "Don't delete devices",     "de": "Geräte nicht löschen",     "ru": "Не удалять устройства"},
    ...
    "This IP is unreachable from %s": {
        "en": "This IP is unreachable from %s",
        "de": "Diese IP ist nicht erreichbar von %s",
        "ru": "Этот IP не доступен для %s"
    },
