...
systemDictionary = {
    'HomeMatic Address': {
        'en': 'HomeMatic Address',
        'de': 'HomeMatic Adresse',
        'ru': 'Адрес HomeMatic',
        'pt': 'Endereço HomeMatic',
        'nl': 'HomeMatic-adres',
        'fr': 'Adresse de HomeMatic',
        'it': 'Indirizzo HomeMatic',
        'es': 'Dirección HomeMatic',
        'pl': 'Adres HomeMatic',
        'zh-cn': 'HomeMatic地址'
    },
    'Adapter Address': {
        'en': 'Adapter Address',
        'de': 'Adapter Adresse',
        'ru': 'Собственный адрес',
        'pt': 'Endereço do adaptador',
        'nl': 'Adapter adres',
        'fr': "Adresse de l'adaptateur",
        'it': "Indirizzo dell'adattatore",
        'es': 'Dirección del adaptador',
        'pl': 'Adres adaptera',
        'zh-cn': '适配器地址'
    },
    'Daemon': {
    ...
    'Adapter Callback Address': {
        ...
        'de': 'Adapter Callback Adresse',
        'ru': 'Собственный Callback адрес',
        'pt': 'Endereço de retorno de chamada do adaptador',
        'nl': 'Adapter-callback-adres',
        'fr': "Adresse de rappel de l'adaptateur",
        'it': "Indirizzo di richiamata dell'adattatore",
        'es': 'Dirección de devolución de llamada del adaptador',
        'pl': 'Adres zwrotny adaptera',
        'zh-cn': '适配器回调地址'
    },
    'Adapter Port': {
        'en': 'Adapter Port',
        'de': 'Adapter Port',
        'ru': 'Порт драйвера ioBroker',
        'pt': 'Porta adaptadora',
        'nl': 'Adapterpoort',
        'fr': "Port de l'adaptateur",
        'it': "Porta dell'adattatore",
        'es': 'Puerto adaptador',
        'pl': 'Port adaptera',
        'zh-cn': '适配器端口'
    },
    ...
    'Check communication interval (sec)': {
        ...
        'fr': "Vérifier l'intervalle de communication (sec)",
        'it': "Controllare l'intervallo di comunicazione (sec)",
        'es': 'Verificar el intervalo de comunicación (sec)',
        'pl': 'Sprawdź interwał komunikacji (s)',
        'zh-cn': '检查通信间隔（秒）'
    },
    'Reconnect interval (sec)': {
        ...
        'fr': 'Intervalle de reconnexion (sec)',
        'it': 'Intervallo di riconnessione (sec)',
        'es': 'Intervalo de reconexión (sec)',
        'pl': 'Interwał ponownego połączenia (s)',
        'zh-cn': '重新连接间隔（秒）'
    },
    'Listen on all IPs': {
        'en': 'Listen on all IPs',
        'de': 'Auf alle IPs hören',
        'ru': 'Слушать на всех IP адресах',
    ...
    'Homematic RPC adapter settings': {
        ...
        'pt': 'Configurações do adaptador Homematic RPC',
        'nl': 'Homematische RPC-adapterinstellingen',
        'fr': "Paramètres de l'adaptateur RPC homématique",
        'it': "Impostazioni dell'adattatore RPC Homematic",
        'es': 'Configuración del adaptador Homematic RPC',
        'pl': 'Homematyczne ustawienia adaptera RPC',
        'zh-cn': 'Homematic RPC适配器设置'
    },
    'This IP is unreachable from %s': {
        ...
        'pt': 'Este IP é inacessível de %s',
        'nl': 'Deze IP is onbereikbaar van %s',
        'fr': 'Cette adresse IP est inaccessible depuis %s',
        'it': 'Questo IP non è raggiungibile da %s',
        'es': 'Este IP es inalcanzable desde %s',
        'pl': 'To IP jest nieosiągalne z %s',
        'zh-cn': '此IP无法从％s访问 %s'
    },
    'Please specify callback address': {
        ...
        'fr': "Veuillez spécifier l'adresse de rappel.",
        'it': "Si prega di specificare l'indirizzo di richiamata.",
        'es': 'Por favor, especifique la dirección de devolución de llamada.',
        'pl': 'Proszę podać adres zwrotny.',
        'zh-cn': '请指定回拨地址。'
    },
    'Ok': {
        'en': 'Ok',
    ...
    'Force objects re-init': {
        ...
        'fr': 'Synchroniser des objets (une fois)',
        'it': 'Sincronizza oggetti (una volta)',
        'es': 'Sincronizar objetos (una vez)',
        'pl': 'Synchronizuj obiekty (raz)',
        'zh-cn': '同步对象（一次）'
    },
    'Use https': {
        'en': 'Use https',
    ...
    'BIN-RPC does not work with HTTPS. HTTPS has been disabled.': {
        ...
        'zh-cn': 'BIN-RPC不适用于HTTPS。 HTTPS已被禁用。'
    }
};
